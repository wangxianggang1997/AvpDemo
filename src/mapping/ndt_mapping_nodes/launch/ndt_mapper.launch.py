...
def generate_launch_description():
    ...
    # 节点1：过滤点云和点云转换（lidar_front->base_link)
    # pkg: perception/filters/point_cloud_filter_transform_nodes; 
    # node: ilter_transform_vlp16_front; 
    # param：param/vlp16_sim_lexus_filter_transform.param.yaml
    ...
    # 节点2：点云降采样 
    # pkg: perception/filters/voxel_grid_nodes; 
    # node: voxel_grid_cloud_node; 
    # param：mapping/ndt_mapping_nodes/param/scan_downsampler.param.yaml
    ...
    #节点3:ndt建图
    #pkg: mapping/ndt_mapping_nodes
    #node: ndt_mapper_node
    #param: param/ndt_mapper.param.yaml
    ndt_mapper = Node(
