...
def generate_launch_description():
    ...
    lgsvl_interface_param = DeclareLaunchArgument(
        ...
        description='Path to config file for LGSVL Interface' #LGSVL接口的配置文件路径
    )
    ...
    # 节点2 filter_transform_vlp16_front 前激光雷达的滤波转换
    filter_transform_vlp16_front = Node(
        ...
        remappings=[("points_in", "points_raw")] #point_in话题名映射为points_raw
    )
    # 节点3 filter_transform_vlp16_rear 后激光雷达的滤波转换
